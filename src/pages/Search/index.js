...
import {View, Text, TextInput, StyleSheet, Keyboard, SafeAreaView, TouchableOpacity, PanResponder} from 'react-native';
...
export default function Search(){
    ...
    async function handleSearch(){
        ///weather?key=e1971675&lat=-23.682&lon=-46.875&user_ip=remote
    ...
    if(city){
        return(
            ...
            <LinearGradient style={styles.header} colors={['#1EB6FF', '#97C1FF']}>
